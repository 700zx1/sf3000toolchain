...
enum AUM_EVENT_TYPE
{
    ...
    AUM_EVT_GET_UPGRADE_BUF,
    AUM_EVT_CERT_INVALID,
};
...
enum AUM_IO_CMD
{
    ...
    AUM_CMD_SET_AOA_VENDOR,
    AUM_CMD_SET_AOA_MODEL,
    AUM_CMD_SET_FRAME_BUF,
    AUM_CMD_SLAVE_START,
    AUM_CMD_SLAVE_STOP,
    AUM_CMD_SLAVE_DEV_TYPE,
    AUM_CMD_INIT,
    AUM_CMD_SETTINGS_CHANGE,
};
...
void aum_ioctl_slave(int cmd, void *param1, void *param2);
void aum_start(void);
void aum_stop(void);
