...
enum IUM_EVENT_TYPE
{
    ...
    IUM_EVT_FAKE_LIB,
    IUM_EVT_NO_DATA,
    IUM_EVT_GET_UPGRADE_BUF,
    IUM_EVT_COPYRIGHT_PROTECTION,
};
...
enum IUM_IO_CMD
{
    ...
    IUM_CMD_SET_FRAME_BUF,
    IUM_CMD_SET_AUDIO_ONOFF,
    IUM_CMD_SET_DEMO_MODE,
    IUM_CMD_SLAVE_DEV_TYPE,
};
...
void ium_ioctl_slave(int cmd, void *param1, void *param2);
void ium_start(void);
void ium_stop(void);
