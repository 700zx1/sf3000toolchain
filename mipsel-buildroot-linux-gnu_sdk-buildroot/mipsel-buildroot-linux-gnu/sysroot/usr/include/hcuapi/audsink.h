...
#define AUDSINK_IOCTL_SET_EOF		_IO (AUDSINK_IOCBASE, 15)
...
#define AUDSINK_SND_DEVBIT_I2SO		(1UL << (0))
#define AUDSINK_SND_DEVBIT_PCMO		(1UL << (1))
#define AUDSINK_SND_DEVBIT_SPO		(1UL << (2))
#define AUDSINK_SND_DEVBIT_DDP_SPO	(1UL << (3))
