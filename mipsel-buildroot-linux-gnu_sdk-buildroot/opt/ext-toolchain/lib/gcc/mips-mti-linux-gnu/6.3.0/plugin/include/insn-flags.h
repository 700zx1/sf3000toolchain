...
#define HAVE_join2_load_storedf ((ENABLE_LD_ST_PAIRS \
   && mips_load_store_bonding_p (operands, DFmode)) && (TARGET_HARD_FLOAT \
				      && TARGET_DOUBLE_FLOAT))
...
#define HAVE_fclass_v2sf ((ISA_HAS_FCLASS) && (TARGET_HARD_FLOAT && TARGET_PAIRED_SINGLE_FLOAT))
#define HAVE_frint_sf ((ISA_HAS_RINT) && (TARGET_HARD_FLOAT))
#define HAVE_frint_df ((ISA_HAS_RINT) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_frint_v2sf ((ISA_HAS_RINT) && (TARGET_HARD_FLOAT && TARGET_PAIRED_SINGLE_FLOAT))
...
#define HAVE_movmisalignhi (ISA_HAS_UNALIGNED_SCALARS)
#define HAVE_movmisalignsi (ISA_HAS_UNALIGNED_SCALARS)
#define HAVE_movmisaligndi ((ISA_HAS_UNALIGNED_SCALARS) && (TARGET_64BIT))
#define HAVE_movmisalignsf ((ISA_HAS_UNALIGNED_SCALARS) && (TARGET_HARD_FLOAT))
#define HAVE_movmisaligndf ((ISA_HAS_UNALIGNED_SCALARS) && (TARGET_HARD_FLOAT \
				      && TARGET_DOUBLE_FLOAT))
...
extern rtx        gen_fclass_v2sf                     (rtx, rtx);
extern rtx        gen_frint_sf                        (rtx, rtx);
extern rtx        gen_frint_df                        (rtx, rtx);
extern rtx        gen_frint_v2sf                      (rtx, rtx);
...
extern rtx        gen_mips_dpau_h_qbl                 (rtx, rtx, rtx);
extern rtx        gen_mips_dpau_h_qbr                 (rtx, rtx, rtx);
extern rtx        gen_mips_dpsu_h_qbl                 (rtx, rtx, rtx);
extern rtx        gen_mips_dpsu_h_qbr                 (rtx, rtx, rtx);
extern rtx        gen_mips_dpaq_s_w_ph                (rtx, rtx, rtx);
extern rtx        gen_mips_dpsq_s_w_ph                (rtx, rtx, rtx);
extern rtx        gen_mips_mulsaq_s_w_ph              (rtx, rtx, rtx);
extern rtx        gen_mips_dpaq_sa_l_w                (rtx, rtx, rtx);
extern rtx        gen_mips_dpsq_sa_l_w                (rtx, rtx, rtx);
extern rtx        gen_mips_maq_s_w_phl                (rtx, rtx, rtx);
extern rtx        gen_mips_maq_s_w_phr                (rtx, rtx, rtx);
extern rtx        gen_mips_maq_sa_w_phl               (rtx, rtx, rtx);
extern rtx        gen_mips_maq_sa_w_phr               (rtx, rtx, rtx);
...
extern rtx        gen_mips_dpa_w_ph                   (rtx, rtx, rtx);
extern rtx        gen_mips_dps_w_ph                   (rtx, rtx, rtx);
...
extern rtx        gen_mips_mulsa_w_ph                 (rtx, rtx, rtx);
...
extern rtx        gen_mips_dpax_w_ph                  (rtx, rtx, rtx);
extern rtx        gen_mips_dpsx_w_ph                  (rtx, rtx, rtx);
extern rtx        gen_mips_dpaqx_s_w_ph               (rtx, rtx, rtx);
extern rtx        gen_mips_dpaqx_sa_w_ph              (rtx, rtx, rtx);
extern rtx        gen_mips_dpsqx_s_w_ph               (rtx, rtx, rtx);
extern rtx        gen_mips_dpsqx_sa_w_ph              (rtx, rtx, rtx);
