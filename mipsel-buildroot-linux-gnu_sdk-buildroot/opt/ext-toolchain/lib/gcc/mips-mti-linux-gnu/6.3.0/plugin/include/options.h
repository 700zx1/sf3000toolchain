...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_UNALIGNED_SCALARS;
#else
  int x_TARGET_UNALIGNED_SCALARS;
#define TARGET_UNALIGNED_SCALARS global_options.x_TARGET_UNALIGNED_SCALARS
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern const char *mips_unique_sections_file;
#else
  const char *x_mips_unique_sections_file;
#define mips_unique_sections_file global_options.x_mips_unique_sections_file
#endif
#ifdef GENERATOR_FILE
extern int TARGET_USE_COPYW_UCOPYW;
#else
  int x_TARGET_USE_COPYW_UCOPYW;
#define TARGET_USE_COPYW_UCOPYW global_options.x_TARGET_USE_COPYW_UCOPYW
#endif
#ifdef GENERATOR_FILE
...
#define MASK_SHRINK_OFFSETS (1 << 23)
...
#define TARGET_SHRINK_OFFSETS ((target_flags & MASK_SHRINK_OFFSETS) != 0)
#define TARGET_SHRINK_OFFSETS_P(target_flags) ((target_flags & MASK_SHRINK_OFFSETS) != 0)
...
enum opt_code
{
  ...
  OPT_mabs_ = 1186,                          /* -mabs= */
  OPT_mandroid = 1187,                       /* -mandroid */
  OPT_march_ = 1188,                         /* -march= */
  OPT_mbionic = 1189,                        /* -mbionic */
  OPT_mblockmov_limit_ = 1190,               /* -mblockmov-limit= */
  OPT_mbranch_cost_ = 1191,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1192,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1193,           /* -mcheck-zero-division */
  OPT_mclib_ = 1194,                         /* -mclib= */
  OPT_mcode_readable_ = 1195,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1196,             /* -mcompact-branches= */
  OPT_mcrc = 1197,                           /* -mcrc */
  OPT_mdead_loads = 1198,                    /* -mdead-loads */
  OPT_mdebug = 1199,                         /* -mdebug */
  OPT_mdebugd = 1200,                        /* -mdebugd */
  OPT_mdivide_breaks = 1201,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1202,                  /* -mdivide-traps */
  OPT_mdmx = 1203,                           /* -mdmx */
  OPT_mdouble_float = 1204,                  /* -mdouble-float */
  OPT_mdsp = 1205,                           /* -mdsp */
  OPT_mdspr2 = 1206,                         /* -mdspr2 */
  OPT_mdspr3 = 1207,                         /* -mdspr3 */
  OPT_meb = 1208,                            /* -meb */
  OPT_mel = 1209,                            /* -mel */
  OPT_membedded_data = 1210,                 /* -membedded-data */
  OPT_meva = 1211,                           /* -meva */
  OPT_mexplicit_relocs = 1212,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1213,                  /* -mextern-sdata */
  OPT_mfix_24k = 1214,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1215,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1216,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1217,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1218,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1219,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1220,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1221,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1222,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1223,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1224,                   /* -mflush-func= */
  OPT_mforbidden_slots = 1225,               /* -mforbidden-slots */
  OPT_mfp_exceptions = 1226,                 /* -mfp-exceptions */
  OPT_mfp32 = 1227,                          /* -mfp32 */
  OPT_mfp64 = 1228,                          /* -mfp64 */
  OPT_mfpxx = 1229,                          /* -mfpxx */
  OPT_mframe_header_opt = 1230,              /* -mframe-header-opt */
  OPT_mfunc_opt_list_ = 1231,                /* -mfunc-opt-list= */
  /* OPT_mfused_madd = 1232, */              /* -mfused-madd */
  OPT_mginv = 1233,                          /* -mginv */
  OPT_mglibc = 1234,                         /* -mglibc */
  OPT_mgp32 = 1235,                          /* -mgp32 */
  OPT_mgp64 = 1236,                          /* -mgp64 */
  OPT_mgpopt = 1237,                         /* -mgpopt */
  OPT_mgrow_frame_downwards = 1238,          /* -mgrow-frame-downwards */
  OPT_mhard_float = 1239,                    /* -mhard-float */
  OPT_mimadd = 1240,                         /* -mimadd */
  OPT_minline_intermix = 1241,               /* -minline-intermix */
  OPT_minterlink_compressed = 1242,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1243,              /* -minterlink-mips16 */
  OPT_mips = 1244,                           /* -mips */
  OPT_mips16 = 1245,                         /* -mips16 */
  OPT_mips3d = 1246,                         /* -mips3d */
  OPT_mllsc = 1247,                          /* -mllsc */
  OPT_mload_store_pairs = 1248,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1249,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1250,                    /* -mlong-calls */
  OPT_mlong32 = 1251,                        /* -mlong32 */
  OPT_mlong64 = 1252,                        /* -mlong64 */
  OPT_mlra = 1253,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1254,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1255,                           /* -mmad */
  OPT_mmadd4 = 1256,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1257,             /* -mmcount-ra-address */
  OPT_mmcu = 1258,                           /* -mmcu */
  OPT_mmemcpy = 1259,                        /* -mmemcpy */
  OPT_mmicromips = 1260,                     /* -mmicromips */
  OPT_mmips16e2 = 1261,                      /* -mmips16e2 */
  OPT_mmsa = 1262,                           /* -mmsa */
  OPT_mmt = 1263,                            /* -mmt */
  OPT_mmusl = 1264,                          /* -mmusl */
  OPT_mnan_ = 1265,                          /* -mnan= */
  OPT_mno_float = 1266,                      /* -mno-float */
  OPT_mno_flush_func = 1267,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1268,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1269,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1270,                     /* -mno-mips3d */
  OPT_modd_spreg = 1271,                     /* -modd-spreg */
  OPT_mpaired_single = 1272,                 /* -mpaired-single */
  OPT_mplt = 1273,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1274,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1275,               /* -mrelax-pic-calls */
  OPT_msched_weight = 1276,                  /* -msched-weight */
  OPT_msdata_num_ = 1277,                    /* -msdata-num= */
  OPT_msdata_opt_list_ = 1278,               /* -msdata-opt-list= */
  OPT_mshared = 1279,                        /* -mshared */
  OPT_mshrink_offsets = 1280,                /* -mshrink-offsets */
  OPT_msingle_float = 1281,                  /* -msingle-float */
  OPT_msmartmips = 1282,                     /* -msmartmips */
  OPT_msoft_float = 1283,                    /* -msoft-float */
  OPT_msplit_addresses = 1284,               /* -msplit-addresses */
  OPT_msym32 = 1285,                         /* -msym32 */
  OPT_msynci = 1286,                         /* -msynci */
  OPT_mtune_ = 1287,                         /* -mtune= */
  OPT_muclibc = 1288,                        /* -muclibc */
  OPT_munaligned_scalars = 1289,             /* -munaligned-scalars */
  OPT_muninit_const_in_rodata = 1290,        /* -muninit-const-in-rodata */
  OPT_munique_sections_ = 1291,              /* -munique-sections= */
  OPT_muse_copyw_ucopyw = 1292,              /* -muse-copyw-ucopyw */
  OPT_muse_save_restore = 1293,              /* -muse-save-restore */
  ...
  OPT_pie = 1315,                            /* -pie */
  OPT_pipe = 1316,                           /* -pipe */
  OPT_posix = 1317,                          /* -posix */
  OPT_print_file_name_ = 1318,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1319,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1320,          /* -print-multi-directory */
  OPT_print_multi_lib = 1321,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1322,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1323,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1324,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1325,               /* -print-prog-name= */
  OPT_print_search_dirs = 1326,              /* -print-search-dirs */
  OPT_print_sysroot = 1327,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1328,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1329,                        /* -profile */
  OPT_pthread = 1330,                        /* -pthread */
  OPT_quiet = 1331,                          /* -quiet */
  OPT_r = 1332,                              /* -r */
  OPT_rdynamic = 1333,                       /* -rdynamic */
  OPT_remap = 1334,                          /* -remap */
  OPT_s = 1335,                              /* -s */
  OPT_s_bc_abi = 1336,                       /* -s-bc-abi */
  ...
  OPT_static_libgcj = 1346,                  /* -static-libgcj */
  ...
  /* OPT_std_c__03 = 1355, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1356, */                /* -std=c++0x */
  OPT_std_c__11 = 1357,                      /* -std=c++11 */
  OPT_std_c__14 = 1358,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1359, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1360, */                /* -std=c++1y */
  OPT_std_c__1z = 1361,                      /* -std=c++1z */
  OPT_std_c__98 = 1362,                      /* -std=c++98 */
  OPT_std_c11 = 1363,                        /* -std=c11 */
  /* OPT_std_c1x = 1364, */                  /* -std=c1x */
  /* OPT_std_c89 = 1365, */                  /* -std=c89 */
  OPT_std_c90 = 1366,                        /* -std=c90 */
  OPT_std_c99 = 1367,                        /* -std=c99 */
  /* OPT_std_c9x = 1368, */                  /* -std=c9x */
  OPT_std_f2003 = 1369,                      /* -std=f2003 */
  OPT_std_f2008 = 1370,                      /* -std=f2008 */
  OPT_std_f2008ts = 1371,                    /* -std=f2008ts */
  OPT_std_f95 = 1372,                        /* -std=f95 */
  OPT_std_gnu = 1373,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1374, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1375, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1376,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1377,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1378, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1379, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1380,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1381,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1382,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1383, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1384, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1385,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1386,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1387, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1388, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1389,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1390, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1391, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1392, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1393,                     /* -std=legacy */
  OPT_symbolic = 1394,                       /* -symbolic */
  OPT_t = 1395,                              /* -t */
  OPT_time = 1396,                           /* -time */
  OPT_time_ = 1397,                          /* -time= */
  OPT_tno_android_cc = 1398,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1399,                 /* -tno-android-ld */
  OPT_traditional = 1400,                    /* -traditional */
  OPT_traditional_cpp = 1401,                /* -traditional-cpp */
  OPT_trigraphs = 1402,                      /* -trigraphs */
  OPT_u = 1403,                              /* -u */
  OPT_undef = 1404,                          /* -undef */
  OPT_v = 1405,                              /* -v */
  OPT_version = 1406,                        /* -version */
  OPT_w = 1407,                              /* -w */
  OPT_wrapper = 1408,                        /* -wrapper */
  OPT_x = 1409,                              /* -x */
  OPT_z = 1410,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
