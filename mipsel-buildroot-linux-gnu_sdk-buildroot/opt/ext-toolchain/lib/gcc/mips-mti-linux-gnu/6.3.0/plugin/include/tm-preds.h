/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/scratch/overtest/root/69361/240198/shared/gcc/gcc/config/mips/mips.md'.  */
...
extern int reg_or_0_operand_mips16e2 (rtx, machine_mode);
...
extern int bit_clear_operand (rtx, machine_mode);
...
{
  if (c >= CONSTRAINT_kf && c <= CONSTRAINT_Yz)
    return;
