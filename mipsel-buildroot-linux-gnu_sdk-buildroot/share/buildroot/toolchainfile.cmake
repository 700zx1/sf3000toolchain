...
set(CMAKE_SYSROOT "${RELOCATED_HOST_DIR}/mipsel-buildroot-linux-gnu/sysroot")
set(CMAKE_FIND_ROOT_PATH "${RELOCATED_HOST_DIR}/mipsel-buildroot-linux-gnu/sysroot")
set(CMAKE_FIND_ROOT_PATH_MODE_PROGRAM NEVER)
set(CMAKE_FIND_ROOT_PATH_MODE_PACKAGE ONLY)
set(CMAKE_FIND_ROOT_PATH_MODE_LIBRARY ONLY)
set(CMAKE_FIND_ROOT_PATH_MODE_INCLUDE ONLY)
set(ENV{PKG_CONFIG_SYSROOT_DIR} "${RELOCATED_HOST_DIR}/mipsel-buildroot-linux-gnu/sysroot")

# This toolchain file can be used both inside and outside Buildroot.
set(CMAKE_C_COMPILER "${RELOCATED_HOST_DIR}/bin/mips-mti-linux-gnu-gcc")
if(1)
  ...
  set(CMAKE_CXX_COMPILER "${RELOCATED_HOST_DIR}/bin/mips-mti-linux-gnu-g++")
endif()
if(1)
  ...
  set(CMAKE_Fortran_COMPILER "${RELOCATED_HOST_DIR}/bin/mips-mti-linux-gnu-gfortran")
endif()
